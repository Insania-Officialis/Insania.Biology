    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "insania_logs_api_biology");

            migrationBuilder.CreateTable(
                name: "r_logs_api_biology",
                schema: "insania_logs_api_biology",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_r_logs_api_biology", x => x.id);
                },
                comment: "Логи сервиса биологии");

            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_biology_data_in",
                schema: "insania_logs_api_biology",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_biology_data_out",
                schema: "insania_logs_api_biology",
                table: "r_logs_api_biology",
                column: "data_out")
                .Annotation("Npgsql:IndexMethod", "gin");
